...
class FrSpider(scrapy.Spider):
    ...
    """
    name = 'fr_spider'
    allowed_domains = ['fr.de']
    start_urls = ['https://www.fr.de/']
    ...
    def parse_article(self, response):
        ...
        for link in links:
            ...
            if (absolute_url not in self.visited_links and '/elibrary/shop' not in absolute_url and '/anzeigen/' not in absolute_url
            and 'webkiosk.' not in absolute_url and '/produktempfehlung/' not in absolute_url):
        ...
        if article_url:
            ...
            if article_date_str:
                ...
                if article_date >= self.date_threshold:
                    ...
                    article_text = response.css('p.id-StoryElement-paragraph::text').getall()
