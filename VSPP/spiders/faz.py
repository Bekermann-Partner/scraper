"""
This module defines the `FazSpider` class, which is a Scrapy spider used to
crawl news articles from the faz website (https://www.faz.net/).
...
class FazSpider(scrapy.Spider):
    """Spider to crawl and scrape news articles from faz's news website.
    ...
    start_urls = ['https://www.faz.net/aktuell/']
        ...
        if '/aktuell/' in article_url:
            ...
            if article_date_str:
                ...
                if article_date >= self.date_threshold:
                    ...
                    article_text = response.css('p.body-elements__paragraph::text').getall()
