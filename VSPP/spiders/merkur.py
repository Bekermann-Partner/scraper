...
class MerkurSpider(scrapy.Spider):
    """Spider to crawl and scrape news articles from merkur's news website.
    ...
    def parse_article(self, response):
        ...
        for link in links:
            ...
            if absolute_url not in self.visited_links and not '/maerkte/' in absolute_url and not '/tv/' in absolute_url:
